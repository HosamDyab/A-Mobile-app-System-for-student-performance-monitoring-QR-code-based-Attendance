  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final double logoSize = isDesktop ? 180 : isTablet ? 150 : 120;
        final double cardMaxWidth = isDesktop ? 650 : isTablet ? 560 : 500;

        final double roleTitleSize = isDesktop ? 38 : isTablet ? 34 : 32;
        final double welcomeSize = isDesktop ? 46 : isTablet ? 42 : 40;
        final double subtitleSize = isDesktop ? 20 : isTablet ? 18 : 17;
                                ...
                                AnimatedBuilder(
                                  ...
                                  builder: (context, child) {
                                    return Transform.translate(
                                      offset: Offset(0, 20 * (1 - _fieldAnimation.value)),
                                      child: Opacity(
                                        ...
                                        child: AnimatedTextField(
                                          ...
                                          validator: (value) {
                                            ...
                                            if (!_isValidMTIEmail(value)) return 'Invalid MTI email format';
                                            return null;
                                          },
                                        ),
                                      ),
                                            ...
                                            TextButton.icon(
                                              onPressed: () {
                                                Navigator.push(
                                                  context,
                                                  AdvancedSlidePageRoute(
                                                    page: ForgotPasswordScreen(roleName: widget.roleName),
                                        ...
                                        child: HoverScaleWidget(
                                          ...
                                          child: Container(
                                            ...
                                            child: ElevatedButton.icon(
                                              ...
                                              label: _isLoading
                                                  ? LoadingAnimation(size: 16, color: Colors.white)
                                                  : Text(
                                                'Log In',
